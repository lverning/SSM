    ...
    <div class="layui-content">
        ...
        <div class="layui-row">        	
            <div class="layui-card positionbox">            	  
					...
					<form class="layui-form" method="post" action="${pageContext.request.contextPath}/book/updateBook.html">
						<input type="hidden" name="id" value="${book.id}">
						 <div class="layui-form-item">
							    <label class="layui-form-label"><span class="col-red"></span>图书名字</label>
							    <div class="layui-input-block">
							      <input type="text" name="bookName" value="${book.bookName}" required lay-verify="title" autocomplete="off" placeholder="请输入图书名字" class="layui-input">
							    </div>
						  </div>
						<div class="layui-form-item">
							<label class="layui-form-label"><span class="col-red"></span>图书作者</label>
							<div class="layui-input-block">
								<input type="text" name="bookAuthor" value="${book.bookAuthor}" required lay-verify="title" autocomplete="off" placeholder="请输入图书作者" class="layui-input">
							</div>
						</div>
						  <div class="layui-form-item">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="bookPrice" value="${book.bookPrice}" required lay-verify="title" autocomplete="off" placeholder="请输入图书价格" class="layui-input">
							</div>
						</div>
						<div class="layui-form-item">
							<label class="layui-form-label"><span class="col-red"></span>生产日期</label>
							<div class="layui-input-block">
								<input type="date" id="bt" name="bookDate"

									   required lay-verify="title" autocomplete="off" placeholder="请输入生产日期" class="layui-input">
							</div>
						</div>
...
<%--							    	 <textarea name="bookDetails"  id="demo" style="display: none;"></textarea>--%>
									<input type="text" name="bookDetails" value="${book.bookDetails}" id="demo" style="display: none;">
							    </div>
							</div>
						<div class="mbrt layui-col-xs6 layui-col-md6">
							<input type="submit" class="layui-btn layui-btn-normal" value="修改图书">
						</div>
					</form>
	...
	if(ddd.getMonth()<10){undefined
		var month = "0"+(ddd.getMonth()+1);
	}

	if(ddd.getDate()<10){undefined
		day = "0"+ddd.getDate();
	}
