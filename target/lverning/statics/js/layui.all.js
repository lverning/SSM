    ...
    D.prototype.config = {
        ...
        var e = this, o = e.config, r = e.elemColorBox[0],
            t = e.elemPicker = i(['<div id="layui-colorpicker' + e.index + '" data-index="' + e.index + '" class="layui-anim layui-anim-upbit layui-colorpicker-main">', '<div class="layui-colorpicker-main-wrapper">', '<div class="layui-colorpicker-basis">', '<div class="layui-colorpicker-basis-white"></div>', '<div class="layui-colorpicker-basis-black"></div>', '<div class="layui-colorpicker-basis-cursor"></div>', "</div>", '<div class="layui-colorpicker-side">', '<div class="layui-colorpicker-side-slider"></div>', "</div>", "</div>", '<div class="layui-colorpicker-main-alpha ' + (o.alpha ? n : "") + '">', '<div class="layui-colorpicker-alpha-bgcolor">', '<div class="layui-colorpicker-alpha-slider"></div>', "</div>", "</div>", function () {
                ...
                return ""
            }(), '<div class="layui-colorpicker-main-input">', '<div class="layui-inline">', '<input type="text" class="layui-input">', "</div>", '<div class="layui-btn-container">', '<button class="layui-btn layui-btn-primary layui-btn-sm" colorpicker-events="clear">娓呯┖</button>', '<button class="layui-btn layui-btn-sm" colorpicker-events="confirm">纭畾</button>', "</div", "</div>", "</div>"].join(""));
...
layui.define("layer", function (e) {
    ...
    u.prototype.set = function (e) {
        ...
        var n = this, u = t(r + function () {
            ...
            select: function () {
                var e, i = "璇烽€夋嫨", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                        ...
                        if (!u) {
                            ...
                            var T = function (e, i, a) {
                                ...
                                return 9 !== i && 13 !== i && 37 !== i && 38 !== i && 39 !== i && 40 !== i && (T(t, function (e) {
                                    e ? x.find("." + r)[0] || x.append('<p class="' + r + '">鏃犲尮閰嶉」</p>') : x.find("." + r).remove()
                ...
                f.each(function (e, l) {
                    ...
                    var h = "string" == typeof r.attr("lay-search"), p = v ? v.value ? i : v.innerHTML || i : i,
                        m = t(['<div class="' + (h ? "" : "layui-unselect ") + a, (u ? " layui-select-disabled" : "") + '">', '<div class="' + n + '">', '<input type="text" placeholder="' + p + '" ' + ('value="' + (d ? f.html() : "") + '"') + (h ? "" : " readonly") + ' class="layui-input' + (h ? "" : " layui-unselect") + (u ? " " + c : "") + '">', '<i class="layui-edge"></i></div>', '<dl class="layui-anim layui-anim-upbit' + (r.find("optgroup")[0] ? " layui-select-group" : "") + '">', function (e) {
                            ...
                            }), 0 === t.length && t.push('<dd lay-value="" class="' + c + '">娌℃湁閫夐」</dd>'), t.join("")
                        }(r.find("*")) + "</dl>", "</div>"].join(""));
        ...
        return e ? d[e] ? d[e]() : a.error("涓嶆敮鎸佺殑" + e + "琛ㄥ崟娓叉煋") : layui.each(d, function (e, t) {
            t()
        }), n
    };
    var d = function () {
        ...
        if (layui.each(d, function (e, l) {
            ...
            if (r.removeClass(o), layui.each(c, function (e, t) {
                ...
                if (a[t]) {
                    ...
                    }(), {tips: 1}) : "alert" === u ? i.alert(f, {title: "鎻愮ず", shadeClose: !0}) : i.msg(f, {
                        icon: 5,
                        shift: 6
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form,
        ...
        N = "layui-table-edit", W = "layui-table-hover", _ = function (e) {
            ...
            }(), "{{# var isSort = !(item2.colGroup) && item2.sort; }}", '<th data-field="{{ item2.field||i2 }}" data-key="{{d.index}}-{{i1}}-{{i2}}" {{# if( item2.parentKey){ }}data-parentkey="{{ item2.parentKey }}"{{# } }} {{# if(item2.minWidth){ }}data-minwidth="{{item2.minWidth}}"{{# } }} ' + t + ' {{# if(item2.unresize || item2.colGroup){ }}data-unresize="true"{{# } }} class="{{# if(item2.hide){ }}layui-hide{{# } }}{{# if(isSort){ }} layui-unselect{{# } }}{{# if(!item2.field){ }} layui-table-col-special{{# } }}">', '<div class="layui-table-cell laytable-cell-', "{{# if(item2.colGroup){ }}", "group", "{{# } else { }}", "{{d.index}}-{{i1}}-{{i2}}", '{{# if(item2.type !== "normal"){ }}', " laytable-cell-{{ item2.type }}", "{{# } }}", "{{# } }}", '" {{#if(item2.align){}}align="{{item2.align}}"{{#}}}>', '{{# if(item2.type === "checkbox"){ }}', '<input type="checkbox" name="layTableCheckbox" lay-skin="primary" lay-filter="layTableAllChoose" {{# if(item2[d.data.checkName]){ }}checked{{# }; }}>', "{{# } else { }}", '<span>{{item2.title||""}}</span>', "{{# if(isSort){ }}", '<span class="layui-table-sort layui-inline"><i class="layui-edge layui-table-sort-asc" title="鍗囧簭"></i><i class="layui-edge layui-table-sort-desc" title="闄嶅簭"></i></span>', "{{# } }}", "{{# } }}", "</div>", "</th>", e.fixed ? "{{# }; }}" : "", "{{# }); }}", "</tr>", "{{# }); }}", "</thead>", "</table>"].join("")
        },
    ...
    F.prototype.config = {
        ...
        var r = {
            filter: {title: "绛涢€夊垪", layEvent: "LAYTABLE_COLS", icon: "layui-icon-cols"},
            exports: {title: "瀵煎嚭", layEvent: "LAYTABLE_EXPORT", icon: "layui-icon-export"},
            print: {title: "鎵撳嵃", layEvent: "LAYTABLE_PRINT", icon: "layui-icon-print"}
        }, d = [];
        ...
        if (i.startTime = (new Date).getTime(), a.url) {
            ...
            a.contentType && 0 == a.contentType.indexOf("application/json") && (d = JSON.stringify(d)), t.ajax({
                ...
                headers: a.headers || {},
                success: function (t) {
                    "function" == typeof a.parseData && (t = a.parseData(t) || t), t[n.statusName] != n.statusCode ? (i.renderForm(), i.layMain.html('<div class="' + f + '">' + (t[n.msgName] || "杩斿洖鐨勬暟鎹笉绗﹀悎瑙勮寖锛屾纭殑鎴愬姛鐘舵€佺爜 (" + n.statusName + ") 搴斾负锛�" + n.statusCode) + "</div>")) : (i.renderData(t, e, t[n.countName]), o(), a.time = (new Date).getTime() - i.startTime + " ms"), i.setColsWidth(), "function" == typeof a.done && a.done(t, e, t[n.countName])
                },
                error: function (e, t) {
                    i.layMain.html('<div class="' + f + '">鏁版嵁鎺ュ彛璇锋眰寮傚父锛�' + t + "</div>"), i.renderForm(), i.setColsWidth()
                }
            })
        ...
        a.layTool.on("click", "*[lay-event]", function (e) {
            ...
            switch (layui.stope(e), R.trigger("table.tool.panel.remove"), l.close(a.tipsIndex), c) {
                ...
                case"LAYTABLE_EXPORT":
                    r.ie ? l.tips("瀵煎嚭鍔熻兘涓嶆敮鎸� IE锛岃鐢� Chrome 绛夐珮绾ф祻瑙堝櫒瀵煎嚭", this, {tips: 3}) : s({
                        list: function () {
                            return ['<li data-type="csv">瀵煎嚭鍒� Csv 鏂囦欢</li>', '<li data-type="xls">瀵煎嚭鍒� Excel 鏂囦欢</li>'].join("")
                        }(), done: function (e, i) {
                            i.on("click", function () {
                    ...
                    break;
                case"LAYTABLE_PRINT":
                    var h = window.open("鎵撳嵃绐楀彛", "_blank"),
...
layui.define("jquery", function (t) {
    ...
    var e = layui.$, i = {
        fixbar: function (t) {
            ...
            return n > 6912e5 ? (n = new Date(t), a[0][0] = i.digit(n.getFullYear(), 4), a[0][1] = i.digit(n.getMonth() + 1), a[0][2] = i.digit(n.getDate()), e || (a[1][0] = i.digit(n.getHours()), a[1][1] = i.digit(n.getMinutes()), a[1][2] = i.digit(n.getSeconds())), a[0].join("-") + " " + a[1].join(":")) : n >= 864e5 ? (n / 1e3 / 60 / 60 / 24 | 0) + "澶╁墠" : n >= 36e5 ? (n / 1e3 / 60 / 60 | 0) + "灏忔椂鍓�" : n >= 12e4 ? (n / 1e3 / 60 | 0) + "鍒嗛挓鍓�" : n < 0 ? "鏈潵" : "鍒氬垰"
        }, digit: function (t, e) {
            var i = "";
            t = String(t), e = e || 2;
